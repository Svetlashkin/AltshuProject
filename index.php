  ...
  <header>
    ...
    <div class="header-content">
      <div class="header-content-right">
        ...
        <p class="header-p-text">Hi! I’m Svetlana, a Full Stack Developer based in Russia. I create information systems
          for fast-growing startups.
        </p>

        <button class="header-button">
          <a class="header-button-text" href="mailto:svetlanatat@mail.ru">Write me!</a>
          <img class="header-button-envelope" src="./assets/images/envelope.png" alt="✉️">
        </button>

        <div class="header-achieve">
          <img class="header-p2-image" src="./assets/images/Vector header_2.png" alt="🏆">
          <div class="header-achieve-content">
            ...
            <div class="header-achieve-content-links">
              ...
              <a class="header-p2-link" href="https://altshu.com/"> • altshu.com </a>
            </div>
          </div>
        </div>
      </div>
      <div class="header-content-left">
        <img class="header-image" src="./assets/images/image 1.jpg" alt="👩🏼‍💻">
      </div>
    </div>
  </header>
  <main>
          ...
          <div class="About-content">
            ...
            <div class="about-left-frame">
              ...
              <div class="about-left-frame-review">
                <div class="stars">
                  <img src="./assets/images/Vector_star.png" alt="⭐">
                  <img src="./assets/images/Vector_star.png" alt="⭐">
                  <img src="./assets/images/Vector_star.png" alt="⭐">
                  <img src="./assets/images/Vector_star.png" alt="⭐">
                  <img src="./assets/images/Vector_star.png" alt="⭐">
                ...
                <div class="reviewer-info">
                  <img class="reviewer-info-foto" src="./assets/images/Rectangle%201.png" alt="🔵">
      ...
      <article id="Services">
        ...
        <div class="services">
          ...
          <article class="services__item">
            <img class="services__item-icon" src="./assets/images/services_image_1.png" alt="🔘">
            <h5 class="services-h5">Branding</h5>
            <p class="services-p">Refresh your logo, revamp your website, and even your letterhead— develop a cohesive
              aesthetic for your
              brand.</p>
          </article>

          <article class="services__item">
            <img class="services__item-icon" src="./assets/images/services_image_2.png" alt="💡">
